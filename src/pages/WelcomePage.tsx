      ...
      <div className="max-w-5xl w-full bg-white rounded-2xl shadow-2xl p-12">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600">
            Soluciones estratégicas para impulsar tu negocio online
          </p>
        </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-700 leading-relaxed">
                  Go beyond rankings. We implement a strategic, technical SEO approach that builds authority, 
                  increases your organic visibility, and ensures you capture only the highest-quality leads 
          ...
          <div className="bg-gradient-to-r from-orange-50 to-amber-50 rounded-xl p-6 border-l-4 border-orange-500">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-700 leading-relaxed">
                  Stop wasting budget on clicks that don't convert. Our expert team manages high-performing 
                  PPC campaigns across Google Ads and social media, driving measurable results and maximizing 
          ...
          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl p-6 border-l-4 border-blue-500">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-700 leading-relaxed">
                  A website is your hardest-working employee. We deliver modern, responsive, and blazing-fast 
                  web design and development, optimized not just for aesthetics, but for seamless user experience 
